 ...
 */
const useClapAnimation = ({ clapEl, countEl, clapTotalEl, children }) => {
...
const Usage = () => {
  ...
  return (
    <div style={{ width: "100%" }}>
      <MediumClap className={userCustomStyles.clap}>
